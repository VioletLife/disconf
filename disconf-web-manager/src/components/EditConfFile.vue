        ...
        <div class="app-statistics-info">
          <el-row style="height: 100%;line-height: 70px;padding-left: 18px;box-sizing: border-box;">
            <el-col :span="4">
              ...
              <span class="app-header-item">winshows_consumer</span>
            </el-col>
            <el-col :span="3">
              <span class="app-header-label">环境配置：</span>
              <span class="app-header-item">rd</span>
            </el-col>
            <el-col :span="3">
              <span class="app-header-label">配置版本：</span>
              <span class="app-header-item">1_0_0_0</span>
            </el-col>
            <el-col :span="4">
              <span class="app-header-label">配置名称：</span>
              <span class="app-header-item">config.properties</span>
            </el-col>
            <el-col :span="3">
